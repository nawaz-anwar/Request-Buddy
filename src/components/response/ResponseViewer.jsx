  ...
  const renderBody = () => {
    ...
    return (
      <div className="h-full flex flex-col">
        ...
        {/* Body Content - Fixed height scrollable container */}
          ...
          {bodyViewMode === 'preview' && isHtmlResponse() ? (
            ...
            <div className="h-full overflow-auto">
              <div className="p-4 h-full">
                <div className="bg-gray-900 dark:bg-gray-950 rounded-lg border border-gray-200 dark:border-gray-700 h-full overflow-hidden">
                  <div className="h-full overflow-auto">
