...
export default function ResponsePanel({ request }) {
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              className="flex items-center space-x-1 px-3 py-1 text-sm border border-gray-300 dark:border-gray-600 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
            >
            ...
            <div className="space-y-2">
              {Object.entries(response.headers || {}).map(([key, value]) => (
                <div key={key} className="flex">
                  <div className="w-1/3 font-medium text-gray-900 dark:text-white pr-4">
                    {key}:
                  </div>
                  <div className="w-2/3 text-gray-600 dark:text-gray-400 font-mono text-sm">
                    {String(value)}
                  </div>
                </div>
              ))}
